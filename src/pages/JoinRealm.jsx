...
const JoinRealm=()=> {
  ...
  const maritalStatusOptions=[ 
    {value: '',label: 'Select...'},{value: 'married',label: 'Married'},{value: 'separated',label: 'Separated'},{value: 'unmarried',label: 'Unmarried'},{value: 'widowed',label: 'Widowed'} 
  ];
      ...
      <div className="min-h-screen bg-accent py-12 flex items-center justify-center relative">
        ...
        >
          ...
          <p className="text-secondary mb-6"> 
            Your registration has been submitted successfully. We'll process your information and send you access details soon. 
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formData.maritalStatus==='married' && (
              <div>
                ...
                <div className="relative">
                  <SafeIcon icon={FiHeart} className="absolute left-3 top-3 h-5 w-5 text-gray-400" />
                  <input 
                    type="date" 
                    name="anniversary" 
