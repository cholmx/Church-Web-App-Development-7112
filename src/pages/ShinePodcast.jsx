    ...
    return (
      <div className="min-h-screen bg-accent py-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-secondary font-inter">Loading podcast episodes...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-accent py-12 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <button onClick={fetchPodcastData} className="p-2 text-primary hover:text-primary-dark transition-colors" title="Refresh episodes">
      ...
      <AnimatePresence>
        {selectedEpisode && selectedEpisode.audioUrl && (
          <AudioPlayer episode={selectedEpisode} onClose={() => setSelectedEpisode(null)} />
        )}
      </AnimatePresence>
    </div>
  );
