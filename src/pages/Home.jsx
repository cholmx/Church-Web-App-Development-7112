...
<h1 className="text-2xl md:text-3xl font-bold text-secondary mb-1" style={{fontFamily: 'Inter Tight, sans-serif'}}>
...
<SafeIcon
icon={button.icon}
className="h-9 w-9 mx-auto mb-3 text-white group-hover:text-yellow-400 group-hover:scale-110 transition-all duration-300"
/>
