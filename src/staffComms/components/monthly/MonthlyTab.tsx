          ...
          <div style="display:flex;gap:${s.gap}in;padding:${s.itemPadV}in 0;${border}align-items:flex-start;">
            ...
            <div style="flex:1;min-width:0;">
              <div style="margin-bottom:${s.titleMarginBottom}pt;">
                <div style="font-family:'Inter Tight',sans-serif;font-size:${s.titleFontSize}pt;font-weight:900;color:${TEAL};letter-spacing:0.02em;line-height:1.1;text-transform:uppercase;">${title}</div>
            ...
            <div key={a.id} style={{ display: 'flex', gap: `${s.gap}in`, padding: `${s.itemPadV}in 0`, borderBottom: i < active.length - 1 ? `1pt solid #E8E8E8` : 'none', alignItems: 'flex-start' }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ marginBottom: `${s.titleMarginBottom}pt` }}>
                  <div style={{ fontFamily: font.display, fontSize: `${s.titleFontSize}pt`, fontWeight: 900, color: TEAL, letterSpacing: '0.02em', lineHeight: 1.1, textTransform: 'uppercase' }}>
                    {a.title}
                  </div>
