...
{showForm && (
<LoadingTransition
isLoading={loading && (editingId || !showForm)}
...
<h3 className="text-2xl text-secondary mb-2" style={{fontFamily: 'Inter Tight,sans-serif',fontWeight: 'bold'}}>
{announcement.title}
</h3>
<div className="announcement-content text-sm mb-2 prose prose-sm max-w-none" dangerouslySetInnerHTML={{__html: announcement.content}} />
